...
public class ChocoboInfoScreen extends Screen {
    public final static ResourceLocation TEXTURE = new ResourceLocation(DelChoco.MOD_ID, "textures/gui/chocobo_stats.png");
    ...
    public ChocoboInfoScreen(Chocobo chocobo, Player player) {
        super(new TranslatableComponent(player.getName().getString()));
        this.chocobo = chocobo;
        this.player = player;
    }

    public static void openScreen(Chocobo chocobo, Player player) {
