...
public class LayerCollar extends RenderLayer<Chocobo, EntityModel<Chocobo>> {
	...
	private static final Map<Integer, ResourceLocation> FEMALE_CHOCOBOS = Util.make(Maps.newHashMap(), (map) ->{
		...
		map.put(3, new ResourceLocation(DelChoco.MOD_ID, "textures/entities/chocobos/collars/f_green_collar.png"));
		map.put(4, new ResourceLocation(DelChoco.MOD_ID, "textures/entities/chocobos/collars/f_blue_collar.png"));
		map.put(5, new ResourceLocation(DelChoco.MOD_ID, "textures/entities/chocobos/collars/f_purple_collar.png"));
		map.put(6, new ResourceLocation(DelChoco.MOD_ID, "textures/entities/chocobos/collars/f_cyan_collar.png"));
		map.put(7, new ResourceLocation(DelChoco.MOD_ID, "textures/entities/chocobos/collars/f_light_gray_collar.png"));
		map.put(8, new ResourceLocation(DelChoco.MOD_ID, "textures/entities/chocobos/collars/f_gray_collar.png"));
		map.put(9, new ResourceLocation(DelChoco.MOD_ID, "textures/entities/chocobos/collars/f_pink_collar.png"));
		map.put(10, new ResourceLocation(DelChoco.MOD_ID, "textures/entities/chocobos/collars/f_lime_collar.png"));
		map.put(11, new ResourceLocation(DelChoco.MOD_ID, "textures/entities/chocobos/collars/f_yellow_collar.png"));
		map.put(12, new ResourceLocation(DelChoco.MOD_ID, "textures/entities/chocobos/collars/f_light_blue_collar.png"));
		map.put(13, new ResourceLocation(DelChoco.MOD_ID, "textures/entities/chocobos/collars/f_magenta_collar.png"));
		map.put(14, new ResourceLocation(DelChoco.MOD_ID, "textures/entities/chocobos/collars/f_orange_collar.png"));
		map.put(15, new ResourceLocation(DelChoco.MOD_ID, "textures/entities/chocobos/collars/f_white_collar.png"));
		map.put(16, new ResourceLocation(DelChoco.MOD_ID, "textures/entities/chocobos/collars/f_red_collar.png"));
	});
	private static final Map<Integer, ResourceLocation> MALE_CHOCOBOS = Util.make(Maps.newHashMap(), (map) ->{
		map.put(1, new ResourceLocation(DelChoco.MOD_ID, "textures/entities/chocobos/collars/m_black_collar.png"));
		map.put(2, new ResourceLocation(DelChoco.MOD_ID, "textures/entities/chocobos/collars/m_brown_collar.png"));
		map.put(3, new ResourceLocation(DelChoco.MOD_ID, "textures/entities/chocobos/collars/m_green_collar.png"));
		map.put(4, new ResourceLocation(DelChoco.MOD_ID, "textures/entities/chocobos/collars/m_blue_collar.png"));
		map.put(5, new ResourceLocation(DelChoco.MOD_ID, "textures/entities/chocobos/collars/m_purple_collar.png"));
		map.put(6, new ResourceLocation(DelChoco.MOD_ID, "textures/entities/chocobos/collars/m_cyan_collar.png"));
		map.put(7, new ResourceLocation(DelChoco.MOD_ID, "textures/entities/chocobos/collars/m_light_gray_collar.png"));
		map.put(8, new ResourceLocation(DelChoco.MOD_ID, "textures/entities/chocobos/collars/m_gray_collar.png"));
		map.put(9, new ResourceLocation(DelChoco.MOD_ID, "textures/entities/chocobos/collars/m_pink_collar.png"));
		map.put(10, new ResourceLocation(DelChoco.MOD_ID, "textures/entities/chocobos/collars/m_lime_collar.png"));
		map.put(11, new ResourceLocation(DelChoco.MOD_ID, "textures/entities/chocobos/collars/m_yellow_collar.png"));
		map.put(12, new ResourceLocation(DelChoco.MOD_ID, "textures/entities/chocobos/collars/m_light_blue_collar.png"));
		map.put(13, new ResourceLocation(DelChoco.MOD_ID, "textures/entities/chocobos/collars/m_magenta_collar.png"));
		map.put(14, new ResourceLocation(DelChoco.MOD_ID, "textures/entities/chocobos/collars/m_orange_collar.png"));
		map.put(15, new ResourceLocation(DelChoco.MOD_ID, "textures/entities/chocobos/collars/m_white_collar.png"));
