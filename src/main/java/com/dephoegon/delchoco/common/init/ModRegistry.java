...
public class ModRegistry {
    ...
    @Contract("false -> new")
    private static Item.@NotNull Properties itemBuilder(boolean fireImmune) { if (fireImmune) { return new Item.Properties().fireResistant();} else { return new Item.Properties(); } }
}