...
public class ModFoods {
	...
	public static final FoodProperties PICKLED_GYSAHL_RAW = (new FoodProperties.Builder()).nutrition(2).saturationMod(1F).build();
	public static final FoodProperties PICKLED_GYSAHL_COOKED = (new FoodProperties.Builder()).nutrition(6).saturationMod(2F).build();
}