...
public class endCityChestAdditionModifier extends LootModifier {
     ...
     */
    protected endCityChestAdditionModifier(LootItemCondition[] conditionsIn, Item additional, float chance, int num) {
        super(conditionsIn);
    ...
    public static class Serializer extends GlobalLootModifierSerializer<endCityChestAdditionModifier> {
        public endCityChestAdditionModifier read(ResourceLocation location, JsonObject object, LootItemCondition[] ailootcondition) {
            Item addition = ForgeRegistries.ITEMS.getValue( new ResourceLocation(GsonHelper.getAsString(object, "addition")));
            float chance = GsonHelper.getAsFloat(object, "chance");
            int number = GsonHelper.getAsInt(object, "number");
            return new endCityChestAdditionModifier(ailootcondition, addition, chance, number);
        }
        public JsonObject write(@NotNull endCityChestAdditionModifier instance) {
