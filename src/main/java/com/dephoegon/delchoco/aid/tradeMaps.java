...
public class tradeMaps {
    ...
    public static final Map<ItemStack, ItemStack> MOD_FARMER_TRADES = Util.make(Maps.newHashMap(), (map) -> {
    ...
    public static final Map<ItemStack, Integer> MOD_TRADE_LEVEL = Util.make(Maps.newHashMap(), (map) -> {
