package com.dephoegon.chococraft.common.world.worldgen;
...
public class ModFeatureConfigs {
	...
	public static final Holder<ConfiguredFeature<RandomPatchConfiguration, ?>> PATCH_GYSAHL_GREEN = FeatureUtils.register("patch_gysahl_green",
			Feature.RANDOM_PATCH, FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(GYSAHL_GREEN)), List.of(Blocks.GRASS_BLOCK), ChocoConfig.COMMON.gysahlGreenPatchSize.get()));
}
